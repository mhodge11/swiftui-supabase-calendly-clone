...
extension Date {
    ...
    // Returns date as 10:00 AM - 10:30 AM, Saturday, August 23, 2023
    func bookingViewDateFormat() -> String {
        ...
        let fullDate = self.fullMonthDayYearFormat()
        
        return "\(start) - \(end), \(day), \(fullDate)"
    }
    
    // Returns date as 9:03 AM
